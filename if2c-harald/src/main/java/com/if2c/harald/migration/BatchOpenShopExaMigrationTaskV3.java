 ...
 * 出口商家创建建帐户、子账号以及开店
 *  出口商家创建建帐户、子账号以及开店
 * [针对自主招商商家  开店二级类目多个（规则例：[201001,201009][208007]）]
 * 
 * @author zhw <br>
 *         Created at 2014年5月14日
 */
public class BatchOpenShopExaMigrationTaskV3 extends ImageMigrationTask {

	public BatchOpenShopExaMigrationTaskV3() throws FileNotFoundException,
			IOException {
		super();
	}

	List<String[]> list = null;
	public static final String EXPORT_FILE = "data/ImportSellerExportYIWU/batch6.csv";
	public static final String FILE_PATH = "E:/速买通开店帐号密码备份";// 帐号密码保存路径
	...
	private void createSellerBrandShop(Connection conn, List<Seller> sellerList)
		...
		//createSellerSQL city=99字段代表通用商家
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		BatchOpenShopExaMigrationTaskV3 task = new BatchOpenShopExaMigrationTaskV3();
		task.run();
		System.exit(0);
	}
}