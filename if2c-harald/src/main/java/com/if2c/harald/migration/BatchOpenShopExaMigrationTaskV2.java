...
/**
 * 出口商家创建建帐户、子账号以及开店 [针对义乌商家 开店二级类目为一个或一级下的所有二级类目]
 * 
 * @author zhw <br>
 *         Created at 2014年4月11日
 */
public class BatchOpenShopExaMigrationTaskV2 extends ImageMigrationTask {

	public BatchOpenShopExaMigrationTaskV2() throws FileNotFoundException,
			IOException {
		super();
	}

	public static final String FILE_PATH = "E:/义乌开店帐号密码备份";// 帐号密码保存路径
	public static final String FILE_NAME = "新建账号密码batch10";// 文件名
	public static final String ERROR_FILE_NAME = "开店失败商家batch10";// 开店失败商家文件名

	List<String[]> list = null;
	public static final String EXPORT_FILE = "E:/批量导入/义乌/批量开店/batch10.csv";
	
	/*public static final String EXPORT_FILE = "data/ImportSellerExportYIWU/batch1.csv";*/
	...
	private void createSellerBrandShop(Connection conn, List<Seller> sellerList)
		...
		// create seller
		String createSellerSQL = "INSERT INTO `seller` (`accountName`,  `password`, `companyName`, `companyAddress`, `email`, `contactPerson`, `contactPhone`, `delivery_country_id`,`operating_mode`,`payment_destination`,`business_location`,`bank_location`,`trade`,`city`,`seller_country_id`) VALUES (?,?,?, ?, ?, ?, ?, '10', '1','1' , '1' , '1' , '2' , '1','10')";
		//createSellerSQL city=1字段代表义乌
		...
		String createShopSQL = "INSERT INTO `shop` (`name`,  `seller_id`,`type`,  `trade`,  `operator_id`) VALUES (?,?,?, '2', '166')";
		...
		for (Seller seller : sellerList) {
			try {
				...
				System.out.println(seller.getAccountName() + ","
						+ seller.getPassword());
				System.out.println(fyAccount + "," + password1);
				System.out.println(pbAccount + "," + password2);
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		BatchOpenShopExaMigrationTaskV2 task = new BatchOpenShopExaMigrationTaskV2();
		task.run();
		System.exit(0);
	}
}
