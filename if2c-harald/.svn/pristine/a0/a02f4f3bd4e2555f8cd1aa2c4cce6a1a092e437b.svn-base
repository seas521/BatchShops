 ...
 */
public class BatchOpenShopExaMigrationTaskV8 extends ImageMigrationTask {

	public BatchOpenShopExaMigrationTaskV8() throws FileNotFoundException,
			IOException {
		super();
...
//				}
	...
	IOException, SQLException {
		BatchOpenShopExaMigrationTaskV8 task=new BatchOpenShopExaMigrationTaskV8();
