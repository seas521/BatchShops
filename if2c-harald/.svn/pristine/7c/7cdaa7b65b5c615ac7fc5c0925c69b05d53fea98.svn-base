 ...
 * 出口商家创建建帐户、子账号以及开店
 *  出口商家创建建帐户、子账号以及开店
 * [针对义乌商家  开店二级类目多个（规则例：[201001,201009][208007]）]
 * 
 * @author zhw <br>
 *         Created at 2014年6月20日
 */
public class BatchOpenShopExaMigrationTaskV4 extends ImageMigrationTask {

	public BatchOpenShopExaMigrationTaskV4() throws FileNotFoundException,
			IOException {
		super();
	}

	List<String[]> list = null;
	public static final String EXPORT_FILE = "E:/批量导入/batch0620_145.csv";
	public static final String FILE_PATH = "E:/义乌开店帐号密码备份";// 帐号密码保存路径
	public static final String FILE_NAME = "新建账号密码batch0620_145";// 文件名
	public static final String ERROR_FILE_NAME = "开店失败商家batch0620_145";// 开店失败商家文件名
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		BatchOpenShopExaMigrationTaskV4 task = new BatchOpenShopExaMigrationTaskV4();
		task.run();
		System.exit(0);
	}
}