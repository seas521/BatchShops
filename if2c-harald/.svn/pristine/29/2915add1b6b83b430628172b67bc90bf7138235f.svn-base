...
public class SmsTimerJob extends JobBase {
	...
	private List<String> getAllUserMobile() {
		String sql = " SELECT mobile FROM base_user WHERE mobile is not null and mobile is not null and mobile!='null' and USER_NAME in('zhonghuawei','qianbing')";
		//String sql = "SELECT mobile FROM base_user WHERE mobile is not null and mobile is not null and mobile!='null'";
